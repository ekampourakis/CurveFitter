Public Class CurveFunctions
    ...
    ' The function.
    Public Shared Function PolynomialFunction(ByVal coeffs As List(Of Double), ByVal x As Double) As Double
    ...
    Public Shared Function FindPolynomialLeastSquaresFit(ByVal points _
        As List(Of PointF), ByVal degree As Integer) As List(Of
        Double)
        ...
        For j As Integer = 0 To degree
            ...
            For a_sub As Integer = 0 To degree
                ...
                coeffs(j, a_sub) = 0
                For Each pt As PointF In points
                    coeffs(j, a_sub) -= Math.Pow(pt.X, a_sub +
                        j)
                Next pt
            Next a_sub
        Next j
